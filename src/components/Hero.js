...
export function initHero() {
  ...
  if (heroMedia) {
    heroMedia.innerHTML = `
      <video autoplay muted loop playsinline preload="auto" poster="./hero-poster.jpg" src="./Video.mp4" style="width: 100%; height: 100%; object-fit: cover; display: block;"></video>
    `;
  }
